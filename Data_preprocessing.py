...
def get_data():
    """
    Call def to get the x and y train, test data. No arguments needed
    """
    ...
    trueDF = pd.read_csv('/Users/lazytreebranch/.cache/kagglehub/datasets/emineyetm/fake-news-detection-datasets/versions/1/News _dataset/True.csv')
    falseDF = pd.read_csv('/Users/lazytreebranch/.cache/kagglehub/datasets/emineyetm/fake-news-detection-datasets/versions/1/News _dataset/Fake.csv')

    print("Length of both datasets:", len(trueDF) + len(falseDF))
