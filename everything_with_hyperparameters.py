...
trueDF = pd.read_csv('/Users/ighacibeh/.cache/kagglehub/datasets/emineyetm/fake-news-detection-datasets/versions/1/News _dataset/True.csv')
falseDF = pd.read_csv('/Users/ighacibeh/.cache/kagglehub/datasets/emineyetm/fake-news-detection-datasets/versions/1/News _dataset/Fake.csv')
...
# Accuracy, precision, and recall all stayed the same with the new hyperparameters
# This will most likely have a different effect when new data is introduced